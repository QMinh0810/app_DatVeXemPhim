...
class VoucherCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isEligible = voucher.isEligible;
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isEligible 
                          ? (isShipping ? const Color(0xFF00BFA5) : const Color(0xFFEE4D2D))
                          : Colors.grey[400],
                    ),
                    child: Column(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 12,
                              color: isEligible ? Colors.grey[600] : Colors.grey[400],
                            ),
                          ),
                          if (!isEligible && voucher.reason != null)
                            Padding(
