...
- UI showtime_screen.dart	Cập nhật thông tin rạp vào trong phần chọn lịch chiếu, UI nên có thêm bộ lọc theo rạp 
- thiết kế UI đổi mật khẩu giống ảnh ChangPasswordScreen.jpg trong source_images
- thiêt kế UI thông tin phim giống ảnh MovieInfo.jpg trong source_images
- thiết kế lại UI seat_selection_screen.dart các ghế hỏng và ghế không tồn tại trong database nhưng được tạo cứng trên UI thì đều là màu xám và không thể chọn.
